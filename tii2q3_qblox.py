...
ADDRESS = "192.168.0.2"
TIME_OF_FLIGHT = 500
RUNCARD = pathlib.Path(__file__).parent / "tii2q3_qblox.yml"
    ...
    "qcm_bb0": ClusterQCM_BB_Settings(
        {
            ...
            "o3": ClusterBB_OutputPort_Settings(
                channel="L1-6",
                gain=0.5,
                qubit="Q1",  # channel="L4-3", gain=0.5, offset=-0.8893, qubit=3
            ),
...
def create(runcard_path=RUNCARD):
    ...
    # feedback
    channels["L2-03"] = Channel(name="L2-03", port=qrm_rf_a.ports["i1"])
    ...
    # TWPA
    channels["L3-16"] = Channel(name="L3-16", port=None) 
    ...
    return Platform(
        "tii2q3_qblox", qubits, pairs, instruments, settings, resonator_type="2D"
    )